...
const testimonials = [
  {
    name: "Иван Петров",
    role: "Частен клиент",
    text: "Работихме с GeoMetric за геодезическо заснемане на парцел преди започване на строеж. Работата беше свършена бързо и много професионално, а комуникацията беше ясна през целия процес.",
  },
  {
  ...
  },
  {
    ...
    role: "Инвеститор",
    text: "Работили сме с различни геодезисти, но при GeoMetric останахме най-доволни. Точност, коректност и много добро отношение към клиента.",
  },
];
