...
export default function TrustBar({ className }: { className?: string }) {
  return (
    <section className={clsx("relative py-10", className)}>
      <div
        className={clsx(
          "rounded-[--radius-card] bg-bg-brand-soft",
          "border border-br-light",
          "shadow-[0_14px_50px_-46px_rgba(0,0,0,0.25)]"
        )}
      >
        <div
          className={clsx(
            ...
            <div key={i} className="flex items-center gap-4">
              <div
                className={clsx(
                  ...
                  "bg-accent/10 ring-1 ring-accent/15",
                  "text-accent"
                )}
              >
              ...
              <div>
                <div className="text-[14px] font-semibold text-tx-primary">{t.title}</div>
                <div className="text-[13px] text-tx-muted">{t.subtitle}</div>
              </div>
            </div>
          ))}
        </div>
