      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            {item.cardMeta && (
              <p className="mt-1 text-sm text-gray-500 font-medium">{item.cardMeta}</p>
            )}
          </div>
        </div>
        {/* Desktop: devider */}
...
//           <p className="mt-0.5 text-[13px] sm:text-[14px] font-semibold text-tx-inverse/70">
//             +{more} налични услуги
//           </p>
//         </div>
//       </div>
...
//       {/* Desktop: divider */}
//       <div className="hidden min-[678px]:block mt-4 h-px w-full bg-tx-inverse/10" />
...
//           "leading-relaxed text-tx-inverse/75",
//           "line-clamp-3 sm:line-clamp-3 lg:line-clamp-4"
//         )}
//       >
...
//           className={clsx(
//             "hidden min-[678px]:inline-flex items-center gap-2",
//             "text-sm font-semibold text-tx-inverse/80",
//             "pt-4 sm:pt-5"
//           )}
//         >
//           Към услуги
