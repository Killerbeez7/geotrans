                ...
                <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
                    ...
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <p className="mt-5 text-lg sm:text-xl text-(--text-secondary)">
                            GeoTrans предлага пълен спектър от геодезически и кадастрални
                            услуги в София и Софийска област – с прецизност, бързина и
                            професионализъм.
                        </p>
                    </div>
                ...
                `}
                    ...
                    <div className="mt-20 text-center">
                        <p className="text-lg text-(--text-secondary) mb-8">
                            Не намирате точната услуга? Свържете се с нас за индивидуално
                            запитване.
                        </p>
                        <Link
                            href="/contacts"
